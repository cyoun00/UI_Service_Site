...
export default function ScreenComponent({ screen }){
    ...
    const [lessonType, setLessonType] = useState("none");
    const [lessonName, setLessonName] = useState("none");
    const [screenType, setScreenType] = useState("lessons");
    ...
    return(
        <div>
            ...
            <section className='screen-background-section'>
                ...
                <section className='screen-foreground-section'>
                    <Card className='card'>
                        ...
                        <section>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("information"); setLessonName(content[screen][tab].lesson1); setLessonType(screen + content[screen][tab].title);}}><img src={moreInfoButton} alt="more info button"></img></Button>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("registration"); setLessonType(screen + content[screen][tab].title);}}><img src={regScreenButton} alt="register button"></img></Button>
                        </section>
                    </Card>
                    <Card className='card'>
                        <Card.Text>{content[screen][tab].lesson2}</Card.Text>
                        <section>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("information"); setLessonName(content[screen][tab].lesson2); setLessonType(screen + content[screen][tab].title);}}><img src={moreInfoButton} alt="more info button"></img></Button>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("registration"); setLessonType(screen + content[screen][tab].title);}}><img src={regScreenButton} alt="register button"></img></Button>
                        </section>
                    </Card>
                    <Card className='card'>
                        ...
                        <section>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("information"); setLessonName(content[screen][tab].lesson3); setLessonType(screen + content[screen][tab].title);}}><img src={moreInfoButton} alt="more info button"></img></Button>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("registration"); setLessonType(screen + content[screen][tab].title);}}><img src={regScreenButton} alt="register button"></img></Button>
                        </section>
                    </Card>
                    <Card className='card'>
                        ...
                        <section>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("information"); setLessonName(content[screen][tab].lesson4); setLessonType(screen + content[screen][tab].title);}}><img src={moreInfoButton} alt="more info button"></img></Button>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("registration"); setLessonType(screen + content[screen][tab].title);}}><img src={regScreenButton} alt="register button"></img></Button>
                        </section>
                    </Card>
                    <Card className='card'>
                        ...
                        <section>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("information"); setLessonName(content[screen][tab].lesson5); setLessonType(screen + content[screen][tab].title);}}><img src={moreInfoButton} alt="more info button"></img></Button>
                            <Button variant="" className='button screen-btn' onClick={() => {setScreenType("registration"); setLessonType(screen + content[screen][tab].title);}}><img src={regScreenButton} alt="register button"></img></Button>
                        </section>
                    </Card>
                </section>
            ...
            {screenType === "information" && (
                <Information lessonName={lessonName} lessonType={lessonType}/>
            )}
        </div>
    );
}